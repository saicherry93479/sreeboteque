...
const ProductList = () => {
  ...
  useEffect(() => {
    ...
    var label = catList?.querySelector("div")?.querySelector("label");
    label?.classList.add("!w-fit");
  }, []);
  ...
  return (
    <div className=" relative  w-full flex-col lg:flex-row w-full px-6 lg:px-12  xl:px-52   py-[24px]  md:py-[24px] lg:py-[24px] bg-white text-white text-[#392a48] mb-[60px] lg:mb-[80px]">
      <div
        id="catList"
        className="w-fit relative  !text-black w-fit !w-full lg:min-w-[600px] lg:max-w-[600px] z-10 ml-auto   "
      >
        <MultiSelect {...props} />
      </div>
